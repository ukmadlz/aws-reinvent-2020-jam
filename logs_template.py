...
Demo_Log_K8S_Routine1 = {
    "line": "131",
    "thread": "SystemMessagePropagatorListenersNotifier",
    "message": "loaded 50 raw patterns, number of types: 1",
    "type": "nginx-log",
    "hostname": "ip-172-32-112-193.ec2.internal",
    "LogSize": "530",
    "loglevel": "INFO",
    "pod-name": "nginx-pz7vl",
    "service": "nginx",
...
Demo_Log_K8S_Routine2 = {
    "line": "197",
    "thread": "SystemMessagePropagatorListenersNotifier",
    "message": "reloading account [19401] log patterns matcher",
    "type": "nginx-log",
    "hostname": "ip-172-32-112-193.ec2.internal",
    "LogSize": "526",
    "loglevel": "INFO",
...
Demo_Log_K8S_Alert = {
    "line": "271",
    "message": "bulk request got failures. failed_count=1 out of bulk_size=2000",
    "type": "nginx-log",
    "hostname": "ip-172-32-112-193.ec2.internal",
    "LogSize": "559",
    "loglevel": "WARNING",
...
Stuck_At_Peak = {
    ...
    "line": "514",
    "type": "k8s-log",
    "message": "Failed to auto-terminate pod",
    "hostname": "ip-172-32-112-193.ec2.internal",
    "LogSize": 412,
    "service": "nginx",
    "loglevel": "FAILURE",
...
Configuration_Change = {
    ...
    "line": "514",
    "type": "k8s-log",
    "message": "k8s configuration changed. launching new configuration",
    "hostname": "ip-172-32-112-193.ec2.internal",
    "LogSize": 389,
    "service": "nginx",
...
System_Configuration_Change = {
    "cluster": "cluster-2",
    "type": "EC2_virtual_machine",
    "message": "system configuration changed. launching new configuration",
    "hostname": "ip-192-168-0-35.ec2.internal",
    "LogSize": 389,
    "service": "orders_influx",
    "department_id": "34F2BG67",
    "department_name": "clothing",
    "store_id": "JX6009R",
    "store_name": "Los_Angeles_Inglewood ",
    "loglevel": "CONFIGURATION",
    "region": "us-west-3"
}
Order_Recieved = {
    "cluster": "cluster-2",
    "type": "EC2_virtual_machine",
    "message": "order received. moving to sorting center",
    "hostname": "ip-192-168-0-35.ec2.internal",
    "LogSize": 389,
    "service": "orders_influx",
    "department_id": "34F2BG67",
    ...
    "store_id": "JX6009R",
    "store_name": "Los_Angeles_Inglewood ",
    "order_id": "TTE455780234X5VC",
    "loglevel": "Order_Recieved",
    "region": "us-west-3"
}
...
Order_Canceled = {
    ...
    "store_id": "JX6009R",
    "store_name": "Los_Angeles_Inglewood ",
    "order_id": "296RB611PE3276",
    "loglevel": "Order_Canceled",
    "region": "us-west-3"
...
Order_Denied = {
    "cluster": "cluster-2",
    "type": "EC2_virtual_machine",
    "message": "order denied. payment transfer unauthorized",
    "hostname": "ip-192-168-0-35.ec2.internal",
    "LogSize": 389,
    "service": "orders_influx",
    "department_id": "34F2BG67",
