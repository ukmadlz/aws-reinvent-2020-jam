from logs_template import suricata_log, px_block_log, aws_login_log, s3_get_object_log, s3_delete_object_log, \
    ...
    Stuck_At_Peak, Configuration_Change, Demo_Log_K8S_Timeout, Demo_Log_K8S_Alert, Demo_Log_K8S_Routine2, Demo_Log_K8S_Routine1
import log_data
...
logs_program = [
    ...
    {"log_type": Demo_Log_K8S_Routine1, "from_time": "15:00:00", "to_time": "04:27:00", "every": 60 * 3,
     "cross_fields": False,
     "fields": [
         {"field_name": 'message', "values": ["loaded 50 raw patterns, number of types: 1"]},
     ]
     },
    {"log_type": Demo_Log_K8S_Routine2, "from_time": "15:00:00", "to_time": "04:27:00", "every": 60 * 3,
     "cross_fields": False,
     "fields": [
         {"field_name": 'LogSize', "values": [160]},
     ]
     },
    {"log_type": Demo_Log_K8S_Alert, "from_time": "04:27:00", "to_time": "14:59:00", "every": 10, "rolling_values": 1,
     "cross_fields": False,
     "fields": [
         {"field_name": 'message',
          "values": ["bulk request got failures. failed_count={} out of bulk_size=400".format(x) for x in
                     range(1, 10000)]},
     ]
     },
    {"log_type": Demo_Log_K8S_Timeout, "from_time": "05:00:00", "to_time": "14:59:00", "every": 10,
     "cross_fields": False,
     "fields": [
         {"field_name": 'LogSize', "values": [2040]},
     ]
     },

    {"log_type": Configuration_Change, "from_time": "02:47:00", "to_time": "02:47:10", "every": 10,
     "cross_fields": False,
     "fields": [
         {"field_name": 'LogSize', "values": [412]}
     ]
     },
    {"log_type": Configuration_Change, "from_time": "03:27:00", "to_time": "03:27:10", "every": 10,
     "cross_fields": False,
     "fields": [
         {"field_name": 'LogSize', "values": [412]}
     ]
     },
    {"log_type": Stuck_At_Peak, "from_time": "05:25:00", "to_time": "05:25:10", "every": 10, "cross_fields": False,
     "fields": [
         {"field_name": 'LogSize', "values": [531]}
     ]
     },
    {"log_type": Stuck_At_Peak, "from_time": "05:30:00", "to_time": "05:30:10", "every": 10, "cross_fields": False,
     "fields": [
         {"field_name": 'LogSize', "values": [531]}
     ]
     }
